    ...
    <div class="product-item bg-light mb-4">
        <div class="product-img position-relative overflow-hidden">
            ...
            <div class="product-action">
                <!-- Update cart button to add item to cart -->
                <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?add=101">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=201"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=301"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=401"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=802"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="detail1.php?Iditem=802">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            ...
                            <h6 style="font-size: 12px; ">
                                <?php
                                    $sql = "SELECT Iditem, Num FROM Product WHERE Iditem = '802'";
                                    $result = $conn->query($sql);
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=402"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="detail1.php?Iditem=402">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            ...
                            <h6 style="font-size: 12px; ">
                                <?php
                                    $sql = "SELECT Iditem, Num FROM Product WHERE Iditem = '402'";
                                    $result = $conn->query($sql);
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=701"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="detail1.php?Iditem=701">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            ...
                            <h6 style="font-size: 12px; ">
                                <?php
                                    $sql = "SELECT Iditem, Num FROM Product WHERE Iditem = '701'";
                                    $result = $conn->query($sql);
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=702"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="detail1.php?Iditem=702">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5 class="text-muted ml-2">$<?php
                                $sql = "SELECT Iditem, Price FROM Product WHERE Iditem = '702'";
                                $result = $conn->query($sql);
                                ...
                                ?>
                            </h5><h6 class="text-muted ml-2"><del>$13,500.00</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h6 style="font-size: 12px; ">เหลือ &nbsp <h6>
                            <h6 style="font-size: 12px; ">
                                <?php
                                    $sql = "SELECT Iditem, Num FROM Product WHERE Iditem = '702'";
                                    $result = $conn->query($sql);
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=602"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="detail1.php?Iditem=602">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5 class="text-muted ml-2">$<?php
                                $sql = "SELECT Iditem, Price FROM Product WHERE Iditem = '602'";
                                $result = $conn->query($sql);
                                ...
                                ?>
                            </h5><h6 class="text-muted ml-2"><del>$750.00</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h6 style="font-size: 12px; ">เหลือ &nbsp <h6>
                            <h6 style="font-size: 12px; ">
                                <?php
                                    $sql = "SELECT Iditem, Num FROM Product WHERE Iditem = '602'";
                                    $result = $conn->query($sql);
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=601"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="detail1.php?Iditem=601">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5 class="text-muted ml-2">$<?php
                                $sql = "SELECT Iditem, Price FROM Product WHERE Iditem = '601'";
                                $result = $conn->query($sql);
                                ...
                                ?>
                            </h5><h6 class="text-muted ml-2"><del>$7,950.00</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h6 style="font-size: 12px; ">เหลือ &nbsp <h6>
                            <h6 style="font-size: 12px; ">
                                <?php
                                    $sql = "SELECT Iditem, Num FROM Product WHERE Iditem = '601'";
                                    $result = $conn->query($sql);
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="add_to_cart.php?Iditem=901"><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="detail1.php?Iditem=901">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5 class="text-muted ml-2">$<?php
                                $sql = "SELECT Iditem, Price FROM Product WHERE Iditem = '901'";
                                $result = $conn->query($sql);
                                ...
                                ?>
                            </h5><h6 class="text-muted ml-2"><del>$13,200.00</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h6 style="font-size: 12px; ">เหลือ &nbsp <h6>
                            <h6 style="font-size: 12px; ">
                                <?php
                                    $sql = "SELECT Iditem, Num FROM Product WHERE Iditem = '901'";
                                    $result = $conn->query($sql);
